...
def test_single_file_default_output(runner, docx_file):
    ...
    mock_convert.assert_called_once_with(
        docx_file, expected_output, "docker.io/pandoc/extra:latest", "docker.io/linuxserver/libreoffice:latest"
    )
...
def test_single_file_explicit_output(runner, docx_file, tmp_path):
    ...
    assert result.exit_code == 0
    mock_convert.assert_called_once_with(docx_file, out, "docker.io/pandoc/extra:latest", "docker.io/linuxserver/libreoffice:latest")
